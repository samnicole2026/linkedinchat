  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: '1',
      role: 'assistant',
      content: "Hi! I'm PLANelope, your AI scheduling assistant. I'm here to help you organize your life intentionally. Tell me about your upcoming commitments, goals, or what you'd like to accomplish this week!",
      timestamp: new Date(),
    },
  ]);
      ...
      <div className="bg-white rounded-2xl shadow-2xl max-w-4xl w-full h-[80vh] flex flex-col">
        <div className="bg-gradient-to-r from-indigo-600 to-purple-600 text-white px-6 py-4 rounded-t-2xl flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-xl font-semibold">Chat with PLANelope</h2>
